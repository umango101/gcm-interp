...
STORY_TMPL = "The {role} came home, put down the bag, and"
...
def stage_build(cfg, professions):
    ...
    names = [
        "maleGenerate-single-desired-all.jsonl", "maleGenerate-single-undesired-all.jsonl",
        "femaleGenerate-single-desired-all.jsonl", "femaleGenerate-single-undesired-all.jsonl",
        "maleGenerate-long-desired-all.jsonl", "maleGenerate-long-undesired-all.jsonl",
        "femaleGenerate-long-desired-all.jsonl", "femaleGenerate-long-undesired-all.jsonl",
    ]
    ...
    for idx, (male_role, female_role, L) in enumerate(pairs):
        ...
        emit("maleGenerate-single-desired-all.jsonl", idx, m_single, "he")
        emit("maleGenerate-single-undesired-all.jsonl", idx, m_single, "she")
        emit("femaleGenerate-single-desired-all.jsonl", idx, f_single, "she")
        emit("femaleGenerate-single-undesired-all.jsonl", idx, f_single, "he")
        emit("maleGenerate-long-desired-all.jsonl", idx, m_story_q, male_story)
        emit("maleGenerate-long-undesired-all.jsonl", idx, m_story_q, female_story)
        emit("femaleGenerate-long-desired-all.jsonl", idx, f_story_q, female_story)
        emit("femaleGenerate-long-undesired-all.jsonl", idx, f_story_q, male_story)
    ...
    # ----------------------------------------------------------------------- #
    steer_names = [
        "maleGenerate-single-steering.jsonl", "femaleGenerate-single-steering.jsonl",
        "maleGenerate-long-steering.jsonl", "femaleGenerate-long-steering.jsonl",
    ]
    ...
    for idx, (male_role, female_role, _L) in enumerate(pairs):
        ...
        emit_steer("maleGenerate-single-steering.jsonl", idx, SINGLE_TMPL.format(role=male_role), "")
        emit_steer("femaleGenerate-single-steering.jsonl", idx, SINGLE_TMPL.format(role=female_role), "")
        emit_steer("maleGenerate-long-steering.jsonl", idx, STORY_TMPL.format(role=male_role), "")
        emit_steer("femaleGenerate-long-steering.jsonl", idx, STORY_TMPL.format(role=female_role), "")
    ...
    # ----------------------------------------------------------------------- #
    test_names = ["maleGenerate-single-test.jsonl", "maleGenerate-long-test.jsonl"]
    ...
    for idx, male_role in test_rows:
        emit_test("maleGenerate-single-test.jsonl", idx, SINGLE_TMPL.format(role=male_role))
        emit_test("maleGenerate-long-test.jsonl", idx, STORY_TMPL.format(role=male_role))

...
export OUTPUT_ROOT="${OUTPUT_ROOT:-$REPO/generate_data/bias_explicit/output}"
export CHECKPOINT_ROOT="${CHECKPOINT_ROOT:-$REPO/generate_data/bias_explicit/checkpoint}"

...
#SBATCH -t 12:00:00
#SBATCH -J mcqa_classify_gender_dataset
...
export OUTPUT_ROOT="${OUTPUT_ROOT:-$REPO/generate_data/biasMCQA_classify/output}"
export CHECKPOINT_ROOT="${CHECKPOINT_ROOT:-$REPO/generate_data/biasMCQA_classify/checkpoint}"
...
python build_gender_dataset_mcqa.py &
PY_PID=$!

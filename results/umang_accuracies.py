...
for source, base in source_base_combos:
    for steer_dir in steer_dirs:
        for eval_dir in eval_dirs:
            for n in Ns:
                for top_k in top_ks:
                    jp_accuracy_5 = calculate_accuracy(
                        jp_df, 
                        eval_dir,
                        steer_dir, 
                        source, 
                    ...
                    jp_accuracy_4 = calculate_accuracy(
                        jp_df, 
                        eval_dir,
                        steer_dir, 
                        source, 
                    ...
                    jp_accuracy_3 = calculate_accuracy(
                        jp_df, 
                        eval_dir,
                        steer_dir, 
                        source, 
                    ...
                    comb_accuracy = calculate_combined_accuracy(
                        jp_df, 
                        rf_flu_df, 
                        rf_rel_df,
                        eval_dir,
                    ...
                    output_file_jp_5 = f"{n}_targeted_steer_topk_{top_k}_gen_accuracy_judge_5.json.accuracy.json"
                    output_file_jp_4 = f"{n}_targeted_steer_topk_{top_k}_gen_accuracy_judge_4.json.accuracy.json"
                    output_file_jp_3 = f"{n}_targeted_steer_topk_{top_k}_gen_accuracy_judge_3.json.accuracy.json"
                    ...
                    output_file_comb = f"{n}_targeted_steer_topk_{top_k}_gen_accuracy_comb.json.accuracy.json"
                    loc_dir = "from_" + source + "_to_" + base

                    output_dir = "results/accuracy/Qwen1.5-14B-Chat/" + loc_dir + "/" + method + "/" + eval_dir + "/" + steer_dir + "/"
                    os.makedirs(output_dir, exist_ok=True)
                    path_jp = os.path.join(output_dir, output_file_jp_5)
                    with open(path_jp, "w") as f:
                        json.dump({"q1": jp_accuracy_5}, f, indent=2)
                    path_jp = os.path.join(output_dir, output_file_jp_4)
                    with open(path_jp, "w") as f:
                        json.dump({"q1": jp_accuracy_4}, f, indent=2)
                    path_jp = os.path.join(output_dir, output_file_jp_3)
                    with open(path_jp, "w") as f:
                        json.dump({"q1": jp_accuracy_3}, f, indent=2)
                    ...
                    path_comb = os.path.join(output_dir, output_file_comb)
                    with open(path_comb, "w") as f:
                        json.dump({"q1": comb_accuracy}, f, indent=2)

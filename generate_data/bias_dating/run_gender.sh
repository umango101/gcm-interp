...
#SBATCH -t 06:00:00
#SBATCH -J dating_gender_dataset
...
export OUTPUT_ROOT="${OUTPUT_ROOT:-$REPO/generate_data/bias_dating/output}"
export CHECKPOINT_ROOT="${CHECKPOINT_ROOT:-$REPO/generate_data/bias_dating/checkpoint}"

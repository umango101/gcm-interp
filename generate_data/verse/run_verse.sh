...
export OUTPUT_ROOT="${OUTPUT_ROOT:-$REPO/generate_data/verse/output}"
export CHECKPOINT_ROOT="${CHECKPOINT_ROOT:-$REPO/generate_data/verse/checkpoint}"

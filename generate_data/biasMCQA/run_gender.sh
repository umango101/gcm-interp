...
export OUTPUT_ROOT="${OUTPUT_ROOT:-$REPO/generate_data/biasMCQA/output}"
export CHECKPOINT_ROOT="${CHECKPOINT_ROOT:-$REPO/generate_data/biasMCQA/checkpoint}"

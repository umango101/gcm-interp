...
#SBATCH -t 06:00:00
#SBATCH -J describe_gender_dataset
...
export OUTPUT_ROOT="${OUTPUT_ROOT:-$REPO/generate_data/bias_describe/output}"
export CHECKPOINT_ROOT="${CHECKPOINT_ROOT:-$REPO/generate_data/bias_describe/checkpoint}"

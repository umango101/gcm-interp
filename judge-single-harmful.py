...
def calculate_accuracy(file_path, base):
    ...
    for item in data:
        # print(base, item)
        if base == 'harmless-single' or base == 'harmless-long': # added the or statement, not sure how differs from line 25
...
for task in tasks:
    ...
    for method in methods:
        ...
        for eval_dir, steering_dir in [('harmful-single_eval', 'harmful-long_steer'), ('harmful-single_eval', 'harmful-single_steer')]:

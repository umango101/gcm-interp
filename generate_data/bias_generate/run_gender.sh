...
#SBATCH -t 12:00:00
#SBATCH -J generate_gender_dataset
...
export OUTPUT_ROOT="${OUTPUT_ROOT:-$REPO/generate_data/bias_generate/output}"
export CHECKPOINT_ROOT="${CHECKPOINT_ROOT:-$REPO/generate_data/bias_generate/checkpoint}"
